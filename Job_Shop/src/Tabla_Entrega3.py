...
for archivo in archivos:
    ...
    try:
        ...
        print(f"\nRealizando Búsqueda con Algoritmo Memético con {iteraciones} iteraciones")
        
        # Ejecución con el número de iteraciones especificado
        poblacion, makespans, promedios = jsp.generacional_con_recocido_simulado(iteraciones)
        val = min(makespans)
        promedio_eval = sum(promedios)/len(promedios)
        sol= poblacion[makespans.index(val)]
        ...
        resultados['busqueda'].append("Recocido Simulado")
